...
export default function StatusBar({ light = false }: { light?: boolean }) {
  ...
  return (
    <div className={`flex items-center justify-between px-5 pt-2 pb-0 ${color} z-10 relative`} style={{ minHeight: 36 }}>
      <span className="text-[15px] font-semibold tracking-tight">{time}</span>
      <div className="flex items-center gap-[5px]">
        {/* Signal bars */}
        <svg width="17" height="11" viewBox="0 0 17 11" fill="currentColor" opacity="0.9">
        ...
        {/* WiFi */}
        <svg width="15" height="11" viewBox="0 0 15 11" fill="currentColor" opacity="0.9">
        ...
        <div className="flex items-center">
          ...
          >
            <div className="h-full bg-white rounded-[1.5px]" style={{ width: "75%" }} />
          </div>
