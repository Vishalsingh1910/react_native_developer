...
const DockIcon = ({ icon, color, onClick }: { icon: React.ReactNode; color: string; onClick?: () => void }) => (
  <motion.button
    onClick={onClick}
    ...
    >
      ...
      <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "10px 18px 16px" }}>
        <div className="rounded-3xl p-3 flex justify-around">
          <DockIcon icon="📞" color="linear-gradient(135deg,#34C759,#248A3D)" onClick={() => window.open("tel:+919033789778", "_self")} />
          <DockIcon
